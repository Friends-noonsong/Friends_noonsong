    ...
    public class ARCoreBackgroundRenderer : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_BackgroundRenderer == null)
            {
                ...
                //m_BackgroundRenderer.camera = m_Camera; // Obsolete Unity 2021.3
                //m_BackgroundRenderer.mode = ARRenderMode.MaterialAsBackground; // Unknow Unity 2021.3
            }
        }
        ...
        private void Disable()
        {
            if (m_BackgroundRenderer != null)
            {
                ...
                m_BackgroundRenderer.GetComponent<Camera>().enabled = false;
