...
public class TalkDialog : MonoBehaviour
{
    ...
    public void SecondDialog()
    {
        ...
        SecondDialog.Add(new DialogData("저기.. 안녕하세요, 처음 보는 분이시네요...!", "NoonGyeol"));
        SecondDialog.Add(new DialogData("눈결이 안녕! 혹시 근처에서 눈송이 못 봤어?", "NoonDung"));
        SecondDialog.Add(new DialogData("눈송이 말인가요? 음... 못 봤어요. 무슨 일이신데요?", "NoonGyeol"));
        SecondDialog.Add(new DialogData("[눈결이에게 사정을 설명한다.]", "User"));
        SecondDialog.Add(new DialogData("앗, 그렇다면 이게 도움이 될 거예요!", "NoonGyeol"));
        SecondDialog.Add(new DialogData("/wait:1.0/저는 지도를 잘 보거든요. 그 외에 이것저것 많은 것을 알고 있으니까, 제 지식이 도움이 될 수 있을 것 같아요.", "NoonGyeol"));
        SecondDialog.Add(new DialogData("[(그럼 혹시 도와줄 수 있냐고 묻는다.)]", "User"));
        SecondDialog.Add(new DialogData("물론이에요..! 저도 동행할게요./wait:1.0/", "NoonGyeol"));
        SecondDialog.Add(new DialogData("으~음... 눈송이 대신 눈결이가 있었네. 괜찮아! 마침 한 곳 더 짐작이 가는 곳이 있어!", "RoRo"));
        SecondDialog.Add(new DialogData("/color:blue/2캠퍼스 정문/color:black/으로 가보자!", "RoRo"));
