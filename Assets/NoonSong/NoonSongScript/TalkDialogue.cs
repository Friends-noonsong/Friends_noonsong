...
public class TalkDialogue : MonoBehaviour // TalkDialogue는 튜토리얼 전체 대사가 들어있음
{
    ...
    public void FirstDialog()
    {
        ...
        FirstDialog.Add(new DialogData("/color:black/[학교가 너무 처음이라 막막하네...]", "User", () => StartCoroutine(MoveObject(noonDung, arCamera.TransformPoint(new Vector3(-1.5f, 1.5f, 5f)), arCamera.TransformPoint(new Vector3(0f, 0f, 2f))))));
        ...
        // part3 로로 등장
        FirstDialog.Add(new DialogData("/color:black//wait:1/앗! 찾았다", "RoRo", () => StartCoroutine(MoveObject(roro, arCamera.TransformPoint(new Vector3(0f, 0f, 10f)), arCamera.TransformPoint(new Vector3(0f, 0f, 2f))))));
    ...
    public void SecondDialog()
    {
        ...
        // part4 눈결이 등장
        SecondDialog.Add(new DialogData("/color:black/[저기 하늘에 떠 다니는 건 뭐지?]", "User"));
        ...
        SecondDialog.Add(new DialogData("/color:black/2캠퍼스 정문으로 가보자!", "RoRo"));
    ...
    public void ThirdDialog()
    {
        ...
        // part5 꽃송이 등장
        ThirdDialog.Add(new DialogData("/color:black/안녕, 친구들? 처음 보는 친구도 있구나! 새송이인가 보네?", "Kkotsong"));
        ...
        ThirdDialog.Add(new DialogData("/color:black/아마 눈송이는 /color:blue/프라임관/color:black/에 있을 거야! 어딘지 아니? 같이 가 줄게.", "Kkotsong"));
    ...
    public void ForthDialog()
    {
        ...
        ForthDialog.Add(new DialogData("/color:black/찾았다, 눈송이!", "Kkotsong"));
        ...
        ForthDialog.Add(new DialogData("/color:black/[(눈송이와 친구가 되자.)]"));
        ForthDialog.Add(new DialogData("/color:black/앗-! 다들 나만 빼고 여기 모여 있었구나!", "Turi"));
